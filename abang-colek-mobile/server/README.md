...
When you need external data, use the omni_search with search_type = 'api' to see there's any built-in api available in Internal API Hub access. You only have to connect other api if there's no suitable built-in api available.
