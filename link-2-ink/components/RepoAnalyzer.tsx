...
const RepoAnalyzer: React.FC<RepoAnalyzerProps> = ({ history, onAddToHistory }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10 mb-20">
      ...
      {error && (
        <div className="max-w-2xl mx-auto p-4 glass-panel border-red-500/30 rounded-xl flex items-center gap-3 text-red-400 animate-in fade-in font-mono text-sm">
